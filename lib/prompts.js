...
{
  "survivors": [
    { "asin": "...", "title": "...", "eliminationReason": null }
  ],
  "eliminated": [
    { "asin": "...", "title": "...", "eliminationReason": "Price ₹24,000 exceeds ₹20,000 limit" }
  ]
}`;
}
 ...
 * @param {Array} products - Array of { asin, title, specs, reviews (formatted string) }
 ...
 * @param {Array} topProducts - Top 3 products from Pass 2, each with { asin, title, score, matchSummary }
...
PASS 2 RANKINGS (from Amazon review analysis):
${pass2Summary}
...
2. CONTRADICTIONS: Do YouTube findings contradict Amazon reviewer experiences?
...
AMAZON REVIEWS (filtered for relevance to user's context):
...
- What do real Amazon reviewers say about use cases similar to this user's?
...
Format:
{
  ...
  "sourcesUsed": ["Amazon specs", "Amazon reviews", "YouTube transcript", "YouTube comments"]
}`;
}
